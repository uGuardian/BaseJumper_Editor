...
public class BehaviourAction_theclaw_ultimateAtk : BehaviourActionBase
{
	public static TheClawUltimateAtk theClawUltimateAtk;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	public BehaviourAction_theclaw_ultimateAtk()
	{
		throw null;
	}
}
