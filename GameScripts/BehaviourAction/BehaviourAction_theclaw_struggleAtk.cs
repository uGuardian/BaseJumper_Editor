...
public class BehaviourAction_theclaw_struggleAtk : BehaviourActionBase
{
	public static TheClawStruggleAtk theClawStruggleAtk;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	public BehaviourAction_theclaw_struggleAtk()
	{
		throw null;
	}
}
