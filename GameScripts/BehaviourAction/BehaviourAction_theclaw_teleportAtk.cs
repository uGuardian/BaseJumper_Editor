...
public class BehaviourAction_theclaw_teleportAtk : BehaviourActionBase
{
	public static TheClawTeleportAtk theClawTeleportAtk;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	public BehaviourAction_theclaw_teleportAtk()
	{
		throw null;
	}
}
