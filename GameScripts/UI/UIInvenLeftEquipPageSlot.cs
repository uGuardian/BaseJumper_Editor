...
namespace UI
{
	public class UIInvenLeftEquipPageSlot : UIOriginEquipPageSlot
	{
		[Header("---Child---")]
		[SerializeField]
		private UIInvenLeftEquipPageList listRoot;
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public UIInvenLeftEquipPageSlot()
		{
			throw null;
		}
	}
