...
namespace UI
{
	public class UIInvenEquipPageListSlot : UIOriginEquipPageList, IPointerDownHandler, IEventSystemHandler
	{
		[Header("---Child---")]
		[SerializeField]
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public UIOriginEquipPageSlot GetFirstSlot()
		{
			throw null;
		}
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public UIInvenEquipPageListSlot()
		{
			throw null;
		}
	}
