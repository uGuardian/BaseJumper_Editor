...
public class PassiveAbility_1301014 : PassiveAbilityBase
{
	...
	private const int _bambooID = 703119;

	private const int _areaID = 703110;

	private const int _patternCntMax = 4;
