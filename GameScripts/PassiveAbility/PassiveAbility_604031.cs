...
public class PassiveAbility_604031 : PassiveAbilityBase
{
	private const int _specialID = 960434;

	private const int _areaID = 960435;

	private const int _specialCond = 2;

	private const int _areaCond = 0;

	private const int _coolTimeMaxSp = 2;

	private const int _coolTimeMaxArea = 3;

	private const int _forcelyAreaTurn = 4;
